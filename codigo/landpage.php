...
<body>
    ...
    <div class="portada">
        ...
        <!-- Texto con efecto portada.js en el span -->
    ...
    <div id="el_proyecto" class="mt-7 cuerpo_fondo">
        <div class="row el_proyecto">
            ...
            <!-- Texto explicativo de la plataforma -->
        ...
        <!-- Botones de registro (no-loggeado) o tienda (loggeado) -->
    ...
    <div id="el_proyecto" class="cuerpo_fondo">
        ...
        <div class="cuerpo_contacto" id="contacto">
            ...
            <!-- 
                Contacto
                Manda el formulario al documento PHP "enviar_mail"
                Si la web no se encuentra desplegada en un servidor, el código dará siempre error en el envío
             -->
